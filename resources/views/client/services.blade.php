    ...
    <div class="bg-blue-50 py-16 border-b border-blue-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                Chúng tôi cung cấp những dịch vụ tốt nhất để thú cưng của bạn luôn xinh đẹp, khỏe mạnh và hạnh phúc.
            </p>
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <a href="{{ route('client.services') }}"
                        class="mt-6 inline-block px-6 py-2 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition shadow">Xem
                        tất cả dịch vụ</a>
                </div>
            @endif
