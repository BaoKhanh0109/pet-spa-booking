                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="role" id="role"
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->roleName }}" {{ old('role', $employee->role) == $role->roleName ? 'selected' : '' }}>
                                            {{ $role->roleName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-2">
                                ...
                                <div id="imagePreview" class="mt-2 hidden">
                                    ...
                                    <img src="" alt="Preview" class="h-32 w-32 object-cover rounded-lg border border-gray-300">
                                </div>
                            </div>
